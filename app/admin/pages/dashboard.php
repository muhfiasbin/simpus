...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMP SWASTA CENDERAMATA</h2>
            <p class="text-center">Alamat : Jl. Periuk No.90, Sei Putih Tengah, Kec. Medan Petisah, Kota Medan, Sumatera Utara 20118</p>
